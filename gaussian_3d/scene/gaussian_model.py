...
from gaussian_3d.utils.general_utils import (
    build_rotation,
...
from gaussian_3d.utils.graphics_utils import BasicPointCloud
from gaussian_3d.utils.rigid_body_utils import (
    get_rigid_transform,
    matrix_to_quaternion,
    quaternion_multiply,
)
from gaussian_3d.utils.sh_utils import RGB2SH
from gaussian_3d.utils.system_utils import mkdir_p
...
class GaussianModel:
    ...
    def extract_mesh(self, path, density_thresh=1, resolution=128, decimate_target=1e5):
        ...
        from gaussian_3d.scene.mesh import Mesh
        from gaussian_3d.scene.mesh_utils import clean_mesh, decimate_mesh
