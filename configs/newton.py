...
result_dir = "./output/newton_results"
exp_name = "newton"

model_list = [
    "./output/newton_inverse_sim_material/newton_material_traindecay_1.0_substep_768_se3_field_lr_0.001_tv_0.0001_iters_200_sw_6_cw_1/seed0/checkpoint_model_000099"
]
...
points_list = [
    np.array([0.399, 0.001, -0.031]),
    np.array([-0.293, -0.005, -0.054]),
]
