...
result_dir = "./output/shirt_results"
exp_name = "shirt"

model_list = [
    "./output/shirt_inverse_sim_material/shirt_material_traindecay_1.0_substep_768_se3_field_lr_0.001_tv_0.0001_iters_200_sw_6_cw_1/seed0/checkpoint_model_000059"
]
...
points_list = [
    np.array([0.003, -0.088, -0.074]),
    np.array([0.023, -0.125, -0.473]),
]
