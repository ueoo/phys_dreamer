...
result_dir = "./output/lamp_results"
exp_name = "lamp"

model_list = [
    "./output/lamp_inverse_sim_material/lamp_material_traindecay_1.0_substep_768_se3_field_lr_0.001_tv_0.0001_iters_200_sw_6_cw_1/seed0/checkpoint_model_000049"
]
...
points_list = [
    np.array([-0.014, -0.255, 0.344]),
    np.array([-0.014, -0.044, 0.500]),
    np.array([-0.003, 0.099, 0.094]),
]
